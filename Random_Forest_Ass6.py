...
#
# .. your code here ..
#X = pd.read_csv('E:\DAT210x-master\DAT210x-master\test_data_rf.csv', sep = ';', decimal = ',')
X = pd.read_csv('http://groupware.les.inf.puc-rio.br/static/har/dataset-har-PUC-Rio-ugulino.zip', sep = ';', decimal = ',')
print (X.head())
